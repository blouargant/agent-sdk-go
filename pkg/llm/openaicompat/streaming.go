...
func (c *OpenAICompatClient) GenerateStream(
	ctx context.Context,
	prompt string,
...
func (c *OpenAICompatClient) GenerateWithToolsStream(
	ctx context.Context,
	prompt string,
...
func (c *OpenAICompatClient) convertToOpenAISchema(params map[string]interfaces.ParameterSpec) map[string]interface{} {
