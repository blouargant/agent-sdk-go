...
// OpenAICompatClient implements the LLM interface for OpenAI
...
type Option func(*OpenAICompatClient)
...
func (c *OpenAICompatClient) getTemperatureForModel(requestedTemp float64) float64 {
...
func NewClient(apiKey string, options ...Option) *OpenAICompatClient {
...
func (c *OpenAICompatClient) Generate(ctx context.Context, prompt string, options ...interfaces.GenerateOption) (string, error) {
	// Apply options
...
func (c *OpenAICompatClient) Chat(ctx context.Context, messages []llm.Message, params *llm.GenerateParams) (string, error) {
	if params == nil {
...
func (c *OpenAICompatClient) GenerateWithTools(ctx context.Context, prompt string, tools []interfaces.Tool, options ...interfaces.GenerateOption) (string, error) {
...
func (c *OpenAICompatClient) SupportsStreaming() bool {
	return true
}

// GetModel returns the model name being used
func (c *OpenAICompatClient) GetModel() string {
	return c.Model
}
...
func (c *OpenAICompatClient) debugHTTPRequest(ctx context.Context, operation string, req interface{}) {
...
func (c *OpenAICompatClient) maskAPIKey() string {
	if len(c.apiKey) <= 8 {
		return "***"
	}
