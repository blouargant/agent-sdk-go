...
// OpenAIBaseClient implements the LLM interface for OpenAI
type OpenAIBaseClient struct {
...
type Option func(*OpenAIBaseClient)

// WithModel sets the model for the OpenAI client
func WithModel(model string) Option {
	return func(c *OpenAIBaseClient) {
		c.Model = model
	}
}

// getTemperatureForModel returns the appropriate temperature for a model
func (c *OpenAIBaseClient) getTemperatureForModel(requestedTemp float64) float64 {
...
func WithReasoningCapabilities(reasoning bool) Option {
	return func(c *OpenAIBaseClient) {
		c.isReasoningModel = reasoning
	}
}

// NewClient creates a new OpenAI client
func NewClient(apiKey string, options ...Option) *OpenAIBaseClient {
...
func (c *OpenAIBaseClient) Generate(ctx context.Context, prompt string, options ...interfaces.GenerateOption) (string, error) {
	// Apply options
...
func (c *OpenAIBaseClient) Chat(ctx context.Context, messages []llm.Message, params *llm.GenerateParams) (string, error) {
	if params == nil {
...
func (c *OpenAIBaseClient) GenerateWithTools(ctx context.Context, prompt string, tools []interfaces.Tool, options ...interfaces.GenerateOption) (string, error) {
...
func (c *OpenAIBaseClient) Name() string {
	return "openai"
}

// SupportsStreaming implements interfaces.LLM.SupportsStreaming
func (c *OpenAIBaseClient) SupportsStreaming() bool {
	return true
}

// GetModel returns the model name being used
func (c *OpenAIBaseClient) GetModel() string {
	return c.Model
}
...
func (c *OpenAIBaseClient) debugHTTPRequest(ctx context.Context, operation string, req interface{}) {
...
func (c *OpenAIBaseClient) maskAPIKey() string {
	if len(c.apiKey) <= 8 {
		return "***"
	}
